...
* [detectImageLoad: boolean;](#lazyload-image)
...
When using any image lazyload methods, you can have `detectImageLoad: false` as one of the masonry options. `detectImageLoad: true` by default.
